...
const EmailCont = () => {
	...
	return (
		<div
			ref={emailRef}
			className="max-sm:hidden w-[5vw] h-screen avengers-rail flex flex-col justify-end items-center pr-4 sm:pr-2"
		>
			<a
				className="text-slate-100 transform font-poppins rotate-90 text-xl mb-32"
